...
async def MaiiiinE():
    ...
    # BOT LOGIN UID
    BOT_UID = int('14361677322')  # <-- FIXED BOT UID

    Uid, Pw = '4390888130', 'S_BLACK_ADMIN_AWMHE'
    ...
    os.system('clear')
    print(render('BLACK ADMIN', colors=['white', 'green'], align='center'))
